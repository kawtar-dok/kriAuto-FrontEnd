    ...
    <>
      <nav className="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          ...
          <Link href="/client/landingClient">
              <img src="/img/logoBlanc.png" alt="logo" className="h-12 " />
            </Link>
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <Link href="/client/agenciesClient">
                  <a
                    className="text-white text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase"
                    href="#pablo"
                  >
              ...
              <li className="flex items-center">
                <Link href="/client/profileClient">
                  <a
                    className="text-white text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase"
                    href="#pablo"
                  >
              ...
              <li className="flex items-center">
                <Link href="/client/aboutUsClient">
                  <a
                    className="text-white text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase"
                    href="#pablo"
                  >
              ...
              <li className="flex items-center">
                <Link href="/client/contactUsClient">
                  <a
                    className="text-white text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase"
                    href="#pablo"
                  >
